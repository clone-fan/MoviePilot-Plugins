...
import { b as getPluginApiEnvelope, u as useSignalTheme, c as usePanelActionRunner } from './useSignalTheme-C9795FwK.js';
import { c9 as mdiCheckCircle, bN as mdiChartPie, ca as mdiArrowUp, cb as mdiArrowDown, cc as mdiCalendarToday, cd as mdiYinYang, ce as mdiEye, cf as mdiLeaf, cg as mdiDatabase, ch as mdiRss, bU as mdiBroom, ba as mdiHeartPulse, aP as mdiRefresh, bD as mdiCloudUploadOutline, ci as mdiTrashCanOutline, cj as mdiTagMultiple, ck as mdiCog, bR as mdiCardPlusOutline, bS as mdiCardAccountDetailsOutline, cl as mdiCalendarCheck, am as _export_sfc } from './mdi-CTgwQT0_.js';
...
const _hoisted_1$e = { class: "signal-dashboard-canvas" };
...
const shellClass = computed$b(() => [
  `signal-dashboard-shell--${props.surface || 'dialog'}`,
  props.themeClass,
]);

return (_ctx, _cache) => {
  return (_openBlock$l(), _createElementBlock$g("section", {
    class: _normalizeClass$8(["dashboard-plugin-vue-renderer signal-dashboard-shell signal-root signal-plugin-shell", shellClass.value])
  }, [
...
const iconStyle = computed$a(() => ({
  '--signal-icon-size': normalizedSize.value,
...
return (_ctx, _cache) => {
  return (_openBlock$j(), _createElementBlock$e("button", {
    type: "button",
    class: _normalizeClass$7(["signal-glass-card signal-pill-button", { 'signal-pill-button--icon': __props.iconOnly }]),
...
const {createElementVNode:_createElementVNode$a,unref:_unref$6,createVNode:_createVNode$b,openBlock:_openBlock$i,createElementBlock:_createElementBlock$d} = await importShared('vue');


const _hoisted_1$b = { class: "signal-dashboard-toolbar" };
const _hoisted_2$a = { class: "signal-dashboard-toolbar__actions" };
...
return (_ctx, _cache) => {
  return (_openBlock$i(), _createElementBlock$d("header", _hoisted_1$b, [
    _cache[2] || (_cache[2] = _createElementVNode$a("div", null, [
      _createElementVNode$a("h1", { class: "signal-dashboard-toolbar__title" }, "MP 运维助手"),
      _createElementVNode$a("span", { class: "signal-dashboard-toolbar__subtitle" }, "仪表盘")
    ], -1)),
    _createElementVNode$a("div", _hoisted_2$a, [
      _createVNode$b(_sfc_main$j, {
        icon: _unref$6(signalIcons).refresh,
        label: "刷新",
        disabled: __props.loading,
        onClick: _cache[0] || (_cache[0] = $event => (_ctx.$emit('refresh')))
      }, null, 8, ["icon", "disabled"]),
      _createVNode$b(_sfc_main$j, {
        icon: _unref$6(signalIcons).cog,
        "icon-only": "",
        label: "设置",
...
const cardClass = computed$9(() => [
  props.light ? 'signal-glass-card-light' : 'signal-glass-card',
  props.className,
]);
...
const _hoisted_1$a = { class: "signal-kpi-card__icon" };
const _hoisted_2$9 = { class: "signal-kpi-card__content" };
const _hoisted_3$9 = { class: "signal-kpi-card__label" };
const _hoisted_4$9 = { class: "signal-kpi-card__value-row" };
const _hoisted_5$5 = {
  key: 0,
  class: "signal-kpi-card__total"
};
const _hoisted_6$4 = {
  key: 1,
  class: "signal-kpi-card__unit"
};
const _hoisted_7$2 = { class: "signal-kpi-card__detail" };
...
return (_ctx, _cache) => {
  return (_openBlock$g(), _createBlock$9(_sfc_main$h, { "class-name": "signal-kpi-card" }, {
    default: _withCtx$5(() => [
      _createElementVNode$9("span", _hoisted_1$a, [
        ...
        (__props.item.dot)
          ? (_openBlock$g(), _createElementBlock$c("span", {
              key: 1,
              class: _normalizeClass$5(["signal-status-dot", { 'signal-status-dot--pulse': __props.item.pulse }])
            }, null, 2))
          : _createCommentVNode$7("", true)
      ]),
      _createElementVNode$9("div", _hoisted_2$9, [
        ...
        _createElementVNode$9("div", _hoisted_4$9, [
          _createElementVNode$9("span", {
            class: _normalizeClass$5(["signal-kpi-card__value", { 'signal-kpi-card__value--large': __props.item.large }])
...
const _hoisted_2$8 = { class: "signal-donut__inner" };
const _hoisted_3$8 = { class: "signal-donut__value" };
const _hoisted_4$8 = { class: "signal-donut__label" };
...
return (_ctx, _cache) => {
  return (_openBlock$e(), _createElementBlock$a("div", {
    class: _normalizeClass$4(["signal-donut", { 'signal-donut--empty': !normalizedSegments.value.length }]),
...
const _hoisted_1$7 = { class: "signal-traffic-summary" };
const _hoisted_2$7 = {
  key: 0,
  class: "signal-traffic-summary__icon",
  "aria-hidden": "true"
};
const _hoisted_3$7 = { class: "signal-traffic-summary__text" };
const _hoisted_4$7 = { class: "signal-traffic-summary__label" };
const _hoisted_5$4 = { class: "signal-traffic-summary__value" };
  ...
  return (_openBlock$d(), _createElementBlock$9("div", _hoisted_1$7, [
    (_openBlock$d(true), _createElementBlock$9(_Fragment$4, null, _renderList$3(__props.rows, (row) => {
      return (_openBlock$d(), _createElementBlock$9("div", {
        key: row.label,
        class: "signal-traffic-summary__pill"
      }, [
        (row.icon)
...
const _hoisted_1$6 = { class: "signal-glass-card-light signal-site-traffic-card" };
const _hoisted_2$6 = { class: "signal-site-traffic-card__identity" };
const _hoisted_3$6 = { class: "signal-site-traffic-card__icon" };
const _hoisted_4$6 = { class: "signal-site-traffic-card__name" };
const _hoisted_5$3 = { class: "signal-site-traffic-card__metrics" };
const _hoisted_6$3 = { class: "signal-site-traffic-card__metric-pill signal-site-traffic-card__metric-pill--upload" };
const _hoisted_7$1 = { class: "signal-site-traffic-card__metric-pill signal-site-traffic-card__metric-pill--download" };
const _hoisted_8$1 = { class: "signal-site-traffic-card__percent" };
const _hoisted_9 = { class: "signal-site-traffic-card__percent-icon" };
...
const _sfc_main$c = {
  ...
  icon: { type: String, default: signalIcons.yinYang },
  ...
  return (_openBlock$c(), _createElementBlock$8("article", _hoisted_1$6, [
    ...
    _createElementVNode$6("div", _hoisted_5$3, [
      _createElementVNode$6("span", _hoisted_6$3, [
        _createVNode$9(_sfc_main$k, {
          icon: _unref$5(signalIcons).arrowUp,
          size: "10"
        }, null, 8, ["icon"]),
      ...
      _createElementVNode$6("span", _hoisted_7$1, [
        _createVNode$9(_sfc_main$k, {
          icon: _unref$5(signalIcons).arrowDown,
          size: "10"
        }, null, 8, ["icon"]),
    ...
    _createElementVNode$6("span", _hoisted_8$1, [
      _createElementVNode$6("span", _hoisted_9, [
        _createVNode$9(_sfc_main$k, {
          icon: _unref$5(signalIcons).chartPie,
          size: "9"
        }, null, 8, ["icon"])
      ]),
...
const _hoisted_1$5 = { class: "signal-card-header" };
const _hoisted_2$5 = { class: "signal-card-heading" };
const _hoisted_3$5 = { class: "signal-card-note" };
const _hoisted_4$5 = { class: "signal-site-panel__body" };
const _hoisted_5$2 = { class: "signal-site-panel__content" };
const _hoisted_6$2 = { class: "signal-site-card-list" };
...
return (_ctx, _cache) => {
  return (_openBlock$b(), _createBlock$7(_sfc_main$h, { "class-name": "signal-site-panel" }, {
    default: _withCtx$4(() => [
      _createElementVNode$5("div", _hoisted_1$5, [
        _createElementVNode$5("h2", _hoisted_2$5, [
          _createVNode$8(_sfc_main$k, {
            icon: _unref$4(signalIcons).leaf,
            color: "#34C759",
            size: "18"
          }, null, 8, ["icon"]),
...
const toneClass = computed$7(() => props.tone ? `signal-status-chip--${props.tone}` : '');

return (_ctx, _cache) => {
  return (_openBlock$a(), _createElementBlock$6("span", {
    class: _normalizeClass$3(["signal-status-chip", toneClass.value])
  }, [
    (__props.icon)
...
const _hoisted_1$4 = { class: "signal-glass-card-light signal-task-tile" };
const _hoisted_2$4 = { class: "signal-task-tile__top" };
const _hoisted_3$4 = { class: "signal-task-tile__name" };
const _hoisted_4$4 = { class: "signal-task-tile__schedule" };
...
const _hoisted_1$3 = { class: "signal-card-header" };
const _hoisted_2$3 = { class: "signal-card-heading" };
const _hoisted_3$3 = {
  key: 0,
  class: "signal-task-grid"
};
const _hoisted_4$3 = {
  key: 1,
  class: "signal-task-empty"
};
...
return (_ctx, _cache) => {
  return (_openBlock$8(), _createBlock$5(_sfc_main$h, { "class-name": "signal-task-panel" }, {
    default: _withCtx$3(() => [
      _createElementVNode$3("div", _hoisted_1$3, [
        _createElementVNode$3("div", _hoisted_2$3, [
          _createVNode$6(_sfc_main$k, {
            icon: _unref$3(signalIcons).calendarCheck,
            color: "#60A5FA",
            size: "18"
          }, null, 8, ["icon"]),
...
const _hoisted_1$2 = { class: "signal-quick-actions" };
const _hoisted_2$2 = { class: "signal-quick-actions__header" };
const _hoisted_3$2 = { class: "signal-quick-actions__grid" };
const _hoisted_4$2 = ["disabled", "aria-busy", "aria-label", "title", "onClick"];
const _hoisted_5$1 = { class: "signal-quick-action__icon" };
const _hoisted_6$1 = { class: "signal-quick-action__label" };
...
return (_ctx, _cache) => {
  return (_openBlock$7(), _createElementBlock$3("section", _hoisted_1$2, [
    _createElementVNode$2("div", _hoisted_2$2, [
      _cache[0] || (_cache[0] = _createElementVNode$2("h2", { class: "signal-quick-actions__title" }, "快捷操作", -1)),
      (__props.feedbackMessage)
        ? (_openBlock$7(), _createElementBlock$3("div", {
            key: 0,
            class: _normalizeClass$2(["signal-action-feedback", { 'signal-action-feedback--bad': !__props.feedbackOk }]),
            role: "status",
            "aria-live": "polite"
    ...
    _createElementVNode$2("div", _hoisted_3$2, [
      (_openBlock$7(true), _createElementBlock$3(_Fragment$1, null, _renderList(__props.actions, (action) => {
        return (_openBlock$7(), _createElementBlock$3("button", {
          key: action.key,
          type: "button",
          class: _normalizeClass$2(["signal-quick-action", { 'signal-quick-action--running': isActionRunning(action) }]),
...
const variantClass = computed$6(() => props.tone ? `signal-icon-circle--${props.tone}` : '');

return (_ctx, _cache) => {
  return (_openBlock$6(), _createElementBlock$2("span", {
    class: _normalizeClass$1(["signal-icon-circle", variantClass.value])
  }, [
...
const _hoisted_1$1 = { class: "signal-glass-card signal-fusion-mini" };
const _hoisted_2$1 = { class: "signal-fusion-mini__updated" };
const _hoisted_3$1 = { class: "signal-fusion-mini__identity" };
const _hoisted_4$1 = { class: "signal-fusion-mini__name" };
const _hoisted_5 = { class: "signal-fusion-mini__status" };
const _hoisted_6 = { class: "signal-fusion-mini__buttons" };
...
return (_ctx, _cache) => {
  return (_openBlock$5(), _createElementBlock$1("article", _hoisted_1$1, [
    ...
    _createVNode$3(_sfc_main$6, {
      icon: _unref$2(signalIcons).cardAccount,
      tone: "blue",
      class: "signal-fusion-mini__icon"
    }, null, 8, ["icon"]),
    _createElementVNode$1("div", _hoisted_3$1, [
      ...
      _createElementVNode$1("div", _hoisted_5, [
        ...
        _createVNode$3(_sfc_main$a, {
          ...
          icon: __props.enabled && __props.isBuilt ? _unref$2(signalIcons).checkCircle : ''
    ...
    _createElementVNode$1("div", _hoisted_6, [
      _createElementVNode$1("button", {
        type: "button",
        class: _normalizeClass(["signal-pill-button signal-pill-button--compact", { 'signal-status-chip--green': __props.enabled }]),
        ...
        _createVNode$3(_sfc_main$k, {
          icon: _unref$2(signalIcons).cardPlus,
          size: "11"
        }, null, 8, ["icon"]),
      ...
      _createElementVNode$1("button", {
        type: "button",
        class: "signal-pill-button signal-pill-button--compact",
        disabled: !__props.enabled || __props.building || __props.refreshing,
        ...
        _createVNode$3(_sfc_main$k, {
          icon: _unref$2(signalIcons).refresh,
          size: "11"
        }, null, 8, ["icon"]),
...
const _hoisted_1 = { class: "signal-core-grid" };
const _hoisted_2 = { class: "signal-glass-card signal-bottom-row" };
const _hoisted_3 = {
  key: 0,
  class: "signal-error"
};
...
const MpSiteDataWidget = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-72c67f71"]]);
...
const MpQuickActionsWidget = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-b4611e74"]]);
