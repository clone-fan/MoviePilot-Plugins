...
import { c as configSchemaFields, n as normalizeCurrentConfig, e as emitConfigSave } from './save-payload-DL7u9KAe.js';
import { p as postPluginApi, g as getPluginApi, u as useSignalTheme, a as useActionRunner } from './useSignalTheme-C9795FwK.js';
...
const _hoisted_3$6 = {
  key: 0,
  class: "signal-field-control__selection-count"
};
const _hoisted_4$5 = {
  key: 0,
  class: "signal-field-control__selection-count"
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$8(), _createElementBlock$6("div", {
    class: _normalizeClass$6(["signal-field-control", {
      'signal-field-control--switch': control.value === 'switch',
      'signal-field-control--switch-on': control.value === 'switch' && !!normalizedValue.value,
      'signal-field-control--multi': !!(__props.field.multiple || __props.field.chips || control.value === 'combobox'),
      'signal-field-control--full': !!(__props.field.fullRow || __props.field.multiple || __props.field.chips || control.value === 'combobox' || control.value === 'textarea'),
    }]),
    "data-field-control": "",
    ...
    (control.value === 'switch')
      ? (_openBlock$8(), _createElementBlock$6("button", {
          key: 0,
          type: "button",
          class: _normalizeClass$6(["signal-toggle-switch", {
        'signal-toggle-switch--on': !!normalizedValue.value,
        'signal-toggle-switch--disabled': !!__props.field.disabled,
      }]),
          role: "switch",
          ...
          _createElementVNode$6("span", {
            class: "signal-toggle-switch__thumb",
            "aria-hidden": "true"
          }, null, -1)
        ]))], 10, _hoisted_2$6))
      : (control.value === 'cron')
                  ...
                  ? {
                      ...
                      fn: _withCtx$3(({ item, props: chipProps }) => [
                        _createVNode$5(_component_VChip, _mergeProps$1(chipProps, {
                          class: "signal-field-control__chip",
                          variant: "tonal"
                        }), {
                          default: _withCtx$3(() => [
...
const FieldControl = /*#__PURE__*/_export_sfc(_sfc_main$8, [['__scopeId',"data-v-8bd1b89e"]]);
...
const _hoisted_2$5 = { class: "signal-field-row__label" };
const _hoisted_3$5 = {
  key: 1,
  class: "signal-field-row__hint"
};
const _hoisted_4$4 = {
  key: 2,
  class: "signal-field-row__error"
};
const _hoisted_5$4 = { class: "signal-field-row__control" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$7(), _createElementBlock$5("div", {
    class: _normalizeClass$5(["signal-field-row signal-design-field", [`signal-field-row--${__props.field.control || 'text'}`, rowClasses.value]]),
    "data-field-row": "",
    "data-html-field": "",
...
const FieldRow = /*#__PURE__*/_export_sfc(_sfc_main$7, [['__scopeId',"data-v-9913e883"]]);
...
const ConfigFieldRow = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-368ac6ac"]]);
...
const _hoisted_2$4 = {
  key: 0,
  class: "signal-config-card__head"
};
const _hoisted_3$4 = { class: "signal-config-card__icon" };
const _hoisted_4$3 = { class: "signal-config-card__copy" };
const _hoisted_5$3 = { key: 0 };
const _hoisted_6$3 = { class: "signal-config-card__trailing" };
const _hoisted_7$3 = {
  key: 1,
  class: "signal-config-card__fields"
};
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$5(), _createElementBlock$4("section", {
    class: _normalizeClass$4(["signal-config-card signal-design-section-card", [`signal-config-card--${__props.cardType}`, { 'signal-config-card--locked': __props.locked, 'signal-config-card--disabled': __props.disabled, 'signal-config-card--embedded': __props.embedded }]]),
...
const ConfigCardBase = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-0e568adb"]]);
...
const _hoisted_2$3 = {
  key: 0,
  class: "signal-schedule-card__group",
  "data-schedule-cron": ""
};
const _hoisted_3$3 = { class: "signal-design-field-grid signal-design-field-grid--grid-2" };
  ...
  return (_openBlock$4(), _createBlock$3(ConfigCardBase, {
    ...
    actions: _withCtx$2(() => [
      _createElementVNode$3("span", {
        class: _normalizeClass$3(["signal-schedule-card__status", { 'signal-schedule-card__status--off': !statusActive.value }]),
...
const ScheduleCard = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-28d5e606"]]);
...
const _hoisted_3$2 = {
  key: 1,
  class: "signal-notify-card__lane signal-notify-card__lane--master",
  "data-notify-master": ""
};
const _hoisted_4$2 = {
  key: 2,
  class: "signal-notify-card__lane signal-notify-card__lane--channel",
  "data-notify-channel": ""
};
const _hoisted_5$2 = {
  key: 3,
  class: "signal-notify-card__lane signal-notify-card__lane--mode",
  "data-notify-mode": ""
};
const _hoisted_6$2 = {
  key: 4,
  class: "signal-notify-card__lane signal-notify-card__lane--rule",
  "data-notify-rule": ""
};
const _hoisted_7$2 = {
  key: 5,
  class: "signal-notify-card__lane signal-notify-card__lane--detail",
  "data-notify-detail": ""
};
  ...
  return (_openBlock$3(), _createBlock$2(ConfigCardBase, {
    ...
    actions: _withCtx$1(() => [
      _createElementVNode$2("span", {
        class: _normalizeClass$2(["signal-notify-card__status", { 'signal-notify-card__status--off': __props.effectiveState === 'plugin_disabled' || !notificationEnabled.value || __props.disabled || __props.locked }]),
        "aria-live": "polite"
      }, [
...
const NotifyCard = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-3c1978ab"]]);
...
const _hoisted_2$1 = { class: "signal-subfill-code__controls" };
const _hoisted_3$1 = ["aria-checked", "disabled"];
const _hoisted_4$1 = { class: "signal-subfill-code__input" };
const _hoisted_5$1 = ["disabled"];
const _hoisted_6$1 = {
  class: "signal-subfill-projection-shell",
  "data-subfill-projection-shell": ""
};
const _hoisted_7$1 = ["aria-expanded"];
const _hoisted_8$1 = { class: "signal-subfill-projection-toggle__label" };
const _hoisted_9$1 = { key: 0 };
const _hoisted_10$1 = ["d"];
const _hoisted_11$1 = {
  key: 0,
  class: "signal-subfill-projection__empty",
  "data-subfill-code-empty": ""
};
const _hoisted_12$1 = {
  key: 1,
  class: "signal-subfill-projection__list",
...
const _hoisted_15$1 = { class: "signal-subfill-code-card__line" };
const _hoisted_16$1 = { class: "signal-subfill-code-card__title" };
const _hoisted_17$1 = { class: "signal-subfill-code-card__summary" };
const _hoisted_18$1 = { key: 0 };
const _hoisted_19$1 = ["d"];
const _hoisted_20$1 = ["id", "aria-labelledby"];
const _hoisted_21$1 = {
  key: 0,
  class: "signal-subfill-code-card__fields"
};
const _hoisted_22$1 = { key: 0 };
const _hoisted_23$1 = {
  key: 1,
  class: "signal-subfill-code-card__errors",
  role: "alert",
  "data-subfill-code-errors": ""
};
const _hoisted_24$1 = {
  key: 2,
  class: "signal-subfill-code-card__preview",
...
return (_ctx, _cache) => {
  return (_openBlock$2(), _createElementBlock$1(_Fragment$1, null, [
    _createElementVNode$1("section", _mergeProps(_unref$1(attrs), {
      class: ["signal-subfill-code", { 'signal-subfill-code--disabled': __props.disabled }],
      ...
      _createElementVNode$1("div", _hoisted_2$1, [
        _createElementVNode$1("button", {
          type: "button",
          class: _normalizeClass$1(["signal-subfill-code__switch", { 'signal-subfill-code__switch--on': enabled.value }]),
          role: "switch",
          ...
          _createElementVNode$1("span", {
            class: _normalizeClass$1(["signal-toggle-switch", { 'signal-toggle-switch--on': enabled.value }]),
            "aria-hidden": "true"
          }, [...(_cache[2] || (_cache[2] = [
            _createElementVNode$1("span", { class: "signal-toggle-switch__thumb" }, null, -1)
          ]))], 2),
      ...
      _createElementVNode$1("div", _hoisted_6$1, [
        _createElementVNode$1("button", {
          ...
          _createElementVNode$1("span", {
            class: _normalizeClass$1(["signal-subfill-projection-toggle__meta", { 'signal-subfill-projection-toggle__meta--error': errorCount.value }])
          }, [
          ...
          (_openBlock$2(), _createElementBlock$1("svg", {
            class: _normalizeClass$1(["signal-subfill-projection-toggle__chevron", { 'signal-subfill-projection-toggle__chevron--open': projectionOpen.value }]),
            viewBox: "0 0 24 24",
            width: "18",
            height: "18",
            "aria-hidden": "true"
            ...
            : (_openBlock$2(), _createElementBlock$1("div", _hoisted_12$1, [
                (_openBlock$2(true), _createElementBlock$1(_Fragment$1, null, _renderList$1(rules.value, (rule) => {
                  return (_openBlock$2(), _createElementBlock$1("article", {
                    ...
                    key: rule.id,
                    class: _normalizeClass$1(["signal-subfill-code-card", { 'signal-subfill-code-card--error': !rule.valid }]),
                    ...
                    _createElementVNode$1("button", {
                      ...
                      (_openBlock$2(), _createElementBlock$1("svg", {
                        class: _normalizeClass$1(["signal-subfill-code-card__chevron", { 'signal-subfill-code-card__chevron--open': isExpanded(rule.id) }]),
                        viewBox: "0 0 24 24",
                        width: "18",
                        height: "18",
                        "aria-hidden": "true"
...
const SubfillRuleEditor = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-dbf4293f"]]);
...
const _hoisted_2 = {
  class: "signal-config-top-bar",
  "data-config-top-bar": ""
};
const _hoisted_3 = { class: "signal-config-top-actions" };
const _hoisted_4 = { class: "signal-config-master-switch" };
...
const _hoisted_8 = ["d"];
const _hoisted_9 = {
  class: "signal-config-subtab-bar",
...
const _hoisted_14 = {
  key: 0,
  class: "signal-config-subtab-current",
  "aria-live": "polite"
};
const _hoisted_15 = ["id", "aria-labelledby", "data-config-active-sub", "data-effective-state"];
const _hoisted_16 = ["data-effective-state"];
const _hoisted_17 = { class: "signal-config-hero-left" };
const _hoisted_18 = { class: "signal-config-hero-icon" };
const _hoisted_19 = ["viewBox"];
const _hoisted_20 = ["d"];
const _hoisted_21 = { class: "signal-config-hero-info" };
const _hoisted_22 = { class: "signal-config-hero-kicker" };
const _hoisted_23 = { class: "signal-config-hero-title" };
const _hoisted_24 = { class: "signal-config-hero-desc" };
const _hoisted_25 = {
  key: 0,
  class: "signal-config-hero-right"
};
const _hoisted_26 = ["aria-checked", "aria-label", "data-config-aggregate-state"];
const _hoisted_27 = {
  key: 1,
  class: "signal-config-hero-right signal-config-hero-right--danger",
...
const _hoisted_29 = {
  class: "signal-mdi-icon signal-fusion-takeover-note__icon",
  viewBox: "0 0 24 24",
  width: "18",
  height: "18",
  "aria-hidden": "true"
...
const _hoisted_36 = {
  class: "signal-seedclean-confirm-dialog",
  role: "dialog",
  "aria-modal": "true",
  "aria-labelledby": "seedclean-confirm-title"
};
const _hoisted_37 = { class: "signal-seedclean-confirm-dialog__head" };
const _hoisted_38 = { id: "seedclean-confirm-title" };
const _hoisted_39 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "18",
  height: "18",
  "aria-hidden": "true"
...
const _hoisted_42 = ["d"];
const _hoisted_43 = { class: "signal-seedclean-confirm-dialog__summary" };
const _hoisted_44 = {
  class: "signal-seedclean-confirm-dialog__items",
  "data-seedclean-confirm-items": ""
};
const _hoisted_45 = { class: "signal-seedclean-confirm-dialog__item" };
const _hoisted_46 = { class: "signal-seedclean-confirm-dialog__actions" };
const _hoisted_47 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "15",
...
const _hoisted_50 = { class: "signal-seedclean-confirm-dialog__head" };
const _hoisted_51 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "18",
...
const _hoisted_52 = ["d"];
const _hoisted_53 = { class: "signal-seedclean-confirm-dialog__warning signal-seedclean-confirm-dialog__warning--danger" };
const _hoisted_54 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "19",
...
const _hoisted_55 = ["d"];
const _hoisted_56 = { class: "signal-seedclean-confirm-dialog__summary" };
const _hoisted_57 = {
  class: "signal-seedclean-confirm-dialog__items",
...
const _hoisted_59 = { class: "signal-seedclean-confirm-dialog__actions" };
const _hoisted_60 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "15",
...
const _hoisted_63 = { class: "signal-seedclean-confirm-dialog__head" };
const _hoisted_64 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "18",
...
const _hoisted_65 = ["d"];
const _hoisted_66 = { class: "signal-seedclean-confirm-dialog__warning" };
const _hoisted_67 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "19",
...
const _hoisted_68 = ["d"];
const _hoisted_69 = { class: "signal-seedclean-confirm-dialog__summary" };
const _hoisted_70 = {
  class: "signal-seedclean-confirm-dialog__items",
  "data-downloader-helper-confirm-items": ""
};
const _hoisted_71 = { class: "signal-seedclean-confirm-dialog__actions" };
const _hoisted_72 = {
  class: "signal-mdi-icon",
  viewBox: "0 0 24 24",
  width: "15",
...
const _hoisted_73 = ["d"];
const _hoisted_74 = {
  class: "signal-config-action-strip",
  "data-config-action-strip": ""
};
const _hoisted_75 = { class: "signal-config-action-strip-copy" };
const _hoisted_76 = { class: "signal-config-action-hint" };
const _hoisted_77 = { class: "signal-config-action-strip-buttons" };
...
return (_ctx, _cache) => {
  return (_openBlock$1(), _createElementBlock("div", {
    ref_key: "configRoot",
    ref: configRoot,
    class: _normalizeClass(["signal-config signal-root signal-plugin-shell", _unref(rootThemeClass)]),
    "data-config-shell": "",
    "data-effective-state": currentEffectiveState.value.code
  }, [
    _createElementVNode("header", _hoisted_2, [
      _createElementVNode("div", { class: "signal-config-brand" }, [
        _createElementVNode("span", { class: "signal-config-brand-icon" }, [
          _createElementVNode("svg", {
            class: "signal-mdi-icon signal-mdi-icon--brand",
            viewBox: "0 0 512 512",
            width: "20",
            height: "20",
            "aria-hidden": "true"
        ...
        _cache[15] || (_cache[15] = _createElementVNode("span", { class: "signal-config-brand-copy" }, [
      ...
      _createElementVNode("div", _hoisted_3, [
        _createElementVNode("div", _hoisted_4, [
          _cache[17] || (_cache[17] = _createElementVNode("span", { class: "signal-config-master-switch__label" }, "插件总开关", -1)),
          _createElementVNode("button", {
            type: "button",
            class: _normalizeClass(["signal-toggle-switch", { 'signal-toggle-switch--on': form.enabled }]),
            role: "switch",
            "aria-checked": !!form.enabled,
            "aria-label": '插件总开关',
            onClick: _cache[0] || (_cache[0] = $event => (form.enabled = !form.enabled))
          }, [...(_cache[16] || (_cache[16] = [
            _createElementVNode("span", { class: "signal-toggle-switch__thumb" }, null, -1)
          ]))], 10, _hoisted_5)
        ]),
        _createElementVNode("button", {
          type: "button",
          ...
          _createElementVNode("svg", {
            class: "signal-mdi-icon signal-mdi-icon--ghost",
            viewBox: "0 0 512 512",
            width: "12",
            height: "12",
            "aria-hidden": "true"
    ...
    _createElementVNode("nav", {
      ...
      (_openBlock$1(true), _createElementBlock(_Fragment, null, _renderList(_unref(mainTabs), (item) => {
        return (_openBlock$1(), _createElementBlock("button", {
          key: item.key,
          type: "button",
          class: _normalizeClass(["signal-config-main-tab", { 'signal-config-main-tab--active': activeMain.value === item.key }]),
          role: "tab",
          ...
          (_openBlock$1(), _createElementBlock("svg", {
            class: "signal-mdi-icon signal-mdi-icon--nav",
      ...
      _createElementVNode("div", {
        ...
        (_openBlock$1(true), _createElementBlock(_Fragment, null, _renderList(currentSubs.value, (sub) => {
          return (_openBlock$1(), _createElementBlock("button", {
            ...
            class: _normalizeClass(["signal-subtab", { 'signal-subtab--active': activeSub.value === sub.key }]),
            role: "tab",
            ...
            (_openBlock$1(), _createElementBlock("svg", {
              class: "signal-mdi-icon signal-mdi-icon--subtab",
    ...
    _createElementVNode("main", {
      ...
      _createElementVNode("section", {
        ...
        _createElementVNode("div", _hoisted_17, [
          _createElementVNode("span", _hoisted_18, [
            (_openBlock$1(), _createElementBlock("svg", {
              class: "signal-mdi-icon signal-mdi-icon--hero",
        ...
        (activeSub.value !== 'clean')
          ? (_openBlock$1(), _createElementBlock("div", _hoisted_25, [
              _createElementVNode("span", {
                class: _normalizeClass(["signal-config-status-badge", { 'signal-config-status-badge--on': heroEffectivelyEnabled.value, 'signal-config-status-badge--mixed': heroEffectivelyMixed.value }])
              }, _toDisplayString(heroStatusText.value), 3),
              _createElementVNode("button", {
                type: "button",
                class: _normalizeClass(["signal-toggle-switch signal-toggle-switch--hero", { 'signal-toggle-switch--on': heroEffectivelyEnabled.value }]),
                role: "switch",
          ...
          : (_openBlock$1(), _createElementBlock("div", _hoisted_27, [...(_cache[20] || (_cache[20] = [
              _createElementVNode("span", { class: "signal-config-status-badge" }, "高风险操作", -1)
            ]))]))
      ], 8, _hoisted_16),
      ...
      _createElementVNode("div", {
        ...
        _createElementVNode("section", {
          class: _normalizeClass(["signal-settings-form-surface", {
              'signal-settings-form-surface--peer': activeSub.value === 'backup' || activeSub.value === 'updates',
              'signal-settings-form-surface--compact-operational': _unref(compactOperationalSubtabs).has(activeSub.value),
            }]),
    ...
    (_openBlock$1(), _createBlock$1(_Teleport, { to: "body" }, [
      (seedCleanConfirmOpen.value)
        ? (_openBlock$1(), _createElementBlock("div", {
            key: 0,
            class: _normalizeClass(["signal-seedclean-confirm-overlay signal-root", _unref(rootThemeClass)]),
            ...
            _createElementVNode("section", _hoisted_36, [
              _createElementVNode("header", _hoisted_37, [
                _createElementVNode("div", null, [
                  _cache[21] || (_cache[21] = _createElementVNode("span", { class: "signal-seedclean-confirm-dialog__kicker" }, "请确认本次处理", -1)),
                  _createElementVNode("h2", _hoisted_38, _toDisplayString(seedCleanActionMeta.value.label), 1)
                ]),
                _createElementVNode("button", {
                  type: "button",
                  class: "signal-seedclean-confirm-dialog__close",
                  "aria-label": "关闭",
                  title: "关闭",
              ...
              _createElementVNode("div", {
                class: _normalizeClass(["signal-seedclean-confirm-dialog__warning", { 'signal-seedclean-confirm-dialog__warning--danger': form.seedclean_action !== 'pause' }])
              }, [
              ...
              _createElementVNode("footer", _hoisted_46, [
                _createElementVNode("button", {
                  type: "button",
                  class: "signal-config-btn signal-config-btn--ghost",
                  "data-seedclean-confirm-cancel": "",
                  onClick: _cache[6] || (_cache[6] = $event => (seedCleanConfirmOpen.value = false))
                }, "返回修改"),
                _createElementVNode("button", {
                  type: "button",
                  class: "signal-config-btn signal-config-btn--save signal-seedclean-confirm-dialog__submit",
            ...
            _createElementVNode("section", _hoisted_49, [
              ...
              _createElementVNode("div", _hoisted_57, [
                (_openBlock$1(true), _createElementBlock(_Fragment, null, _renderList(selectedPluginUninstallItems.value, (item) => {
                  return (_openBlock$1(), _createElementBlock("div", {
                    key: item.value,
                    class: "signal-seedclean-confirm-dialog__item"
                  }, [
            ...
            _createElementVNode("section", _hoisted_62, [
              _createElementVNode("header", _hoisted_63, [
                _cache[26] || (_cache[26] = _createElementVNode("div", null, [
                  _createElementVNode("span", { class: "signal-seedclean-confirm-dialog__kicker" }, "一次确认"),
    ...
    _createElementVNode("footer", _hoisted_74, [
      _createElementVNode("div", _hoisted_75, [
        ...
        _createVNode(_Transition, { name: "signal-fade" }, {
          default: _withCtx(() => [
            (_unref(action).message)
              ? (_openBlock$1(), _createElementBlock("strong", {
                  key: 0,
                  class: _normalizeClass(["signal-config-action-feedback", { 'signal-config-action-feedback--ok': _unref(action).ok, 'signal-config-action-feedback--err': !_unref(action).ok }])
      ...
      _createElementVNode("div", _hoisted_77, [
        ...
        _createElementVNode("button", {
          type: "button",
          class: "signal-config-btn signal-config-btn--save",
          "data-config-save-button": "",
          onClick: saveConfig
        }, [
          _createElementVNode("svg", {
            class: "signal-mdi-icon signal-mdi-icon--save",
            viewBox: "0 0 448 512",
            width: "11.375",
            height: "13",
            "aria-hidden": "true"
