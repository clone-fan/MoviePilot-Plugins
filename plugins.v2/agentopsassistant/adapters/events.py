...
class EventsMixin:
    ...
    def handle_command(self, event: Event = None):
        ...
        handlers = {
            "mpops_report": [("每日汇报", self.run_daily_report, "daily_report")],
            "mpops_subscribe": [("订阅追新", self.run_subscribe_reminder, "subscribe_reminder")],
            "mpops_report_preview": [("预览每日汇报", self.run_daily_report_preview, "daily_report")],
            "mpops_health": [("健康巡查", self.run_health_check, "health_check")],
            "mpops_logs": [("日志清理预览", self.run_log_preview, "log_clean")],
            "mpops_logs_clean": [("日志清理", self.run_log_clean, "log_clean")],
            "mpops_backup": [("自动备份", self.run_backup, "backup")],
            "mpops_updates": [("主程序更新检查", self.run_mp_update_check, "mp_update")],
            "mpops_market": [("插件库更新", self.run_market_update, "market_update")],
            "mpops_run_all": [("每日汇报", self.run_daily_report, "daily_report"), ("健康巡查", self.run_health_check, "health_check")],
            "mpops_plugin_preview": [("插件卸载预览", self.run_plugin_uninstall_preview, None)],
            "mpops_plugin_clean": [("插件卸载", self.run_plugin_uninstall_confirm_required, None)],
            "mpops_seed_clean": [("自动删种", self.run_seed_clean, "seed_clean")],
        }
