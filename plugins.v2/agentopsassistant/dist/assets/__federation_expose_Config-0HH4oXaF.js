...
const _hoisted_32 = { class: "aoa-health-section-head" };
const _hoisted_33 = { class: "aoa-health-grid" };
const _hoisted_34 = { class: "aoa-health-check-text" };
const _hoisted_35 = { class: "aoa-health-check-title" };
const _hoisted_36 = { class: "aoa-health-check-desc" };
const _hoisted_37 = { class: "aoa-health-section" };
const _hoisted_38 = { class: "aoa-health-scope-grid" };
const _hoisted_39 = { class: "aoa-health-action-row" };
const _hoisted_40 = { class: "aoa-pane" };
const _hoisted_41 = { class: "aoa-btn-row" };
const _hoisted_42 = { class: "aoa-pane" };
const _hoisted_43 = { class: "d-flex align-center justify-space-between mb-1" };
...
const _hoisted_53 = { class: "aoa-btn-row" };
const _hoisted_54 = { class: "aoa-pane" };
const _hoisted_55 = { class: "aoa-seed-options" };
const _hoisted_56 = { class: "aoa-seed-action-row" };
const _hoisted_57 = { class: "aoa-seed-action-type" };
const _hoisted_58 = { class: "aoa-pane aoa-media-pane" };
const _hoisted_59 = { class: "aoa-inline-switch" };
const _hoisted_60 = { class: "aoa-pane" };
const _hoisted_61 = { class: "aoa-btn-row" };
          ...
          _createElementVNode("section", _hoisted_6, [
            ...
            _createElementVNode("div", _hoisted_11, [
                ...
                _createVNode(_component_VForm, { class: "aoa-health-form" }, {
                  default: _withCtx(() => [
                    ...
                    _createElementVNode("div", _hoisted_31, [
                      _createElementVNode("div", _hoisted_32, [
                        _cache[139] || (_cache[139] = _createElementVNode("div", null, [
                          _createElementVNode("div", { class: "aoa-health-section-title" }, "巡查项目"),
                          _createElementVNode("div", { class: "aoa-health-section-note" }, "留空时默认检查全部项目")
                        ], -1)),
                        _createVNode(_component_VSelect, {
                          ...
                          "closable-chips": "",
                          clearable: "",
                          class: "aoa-health-project-select",
                        ...
                        (_openBlock(), _createElementBlock(_Fragment, null, _renderList(healthCheckItems, (item) => {
                          return _createElementVNode("div", {
                            ...
                            _createElementVNode("div", _hoisted_34, [
                              _createElementVNode("div", _hoisted_35, _toDisplayString(item.title), 1),
                              _createElementVNode("div", _hoisted_36, _toDisplayString(item.desc), 1)
                            ])
                          ], 2)
                        }), 64))
                      ])
                    ...
                    _createElementVNode("div", _hoisted_37, [
                      _cache[140] || (_cache[140] = _createElementVNode("div", { class: "aoa-health-section-head" }, [
                        _createElementVNode("div", null, [
                          _createElementVNode("div", { class: "aoa-health-section-title" }, "巡查范围"),
                          _createElementVNode("div", { class: "aoa-health-section-note" }, "数据库、容量阈值、存储与目录都可单独控制")
                        ])
                      ], -1)),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_40, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[146] || (_cache[146] = _createElementVNode("div", { class: "aoa-section-title" }, "订阅规则填充", -1)),
                    _cache[147] || (_cache[147] = _createElementVNode("div", { class: "aoa-hint mb-2" }, "电视剧订阅下载到资源后，用实际规格自动回填订阅中“尚为空”的规则，锁定后续剧集追同款版本，已设置的字段不会被覆盖", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[142] || (_cache[142] = _createElementVNode("div", { class: "aoa-hint" }, "监听下载添加事件（仅电视剧），每个剧集 tmdbid 只填充一次", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_VCol, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, { cols: "12" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[143] || (_cache[143] = _createElementVNode("div", { class: "aoa-hint" }, "从下载资源中提取并回填：分辨率 / 资源质量 / 特效 / 制作组 / 站点，留空则不填充", -1))
                          ]),
                          _: 1
                        })
                      ]),
                    ...
                    _createVNode(_component_VDivider, { class: "my-4" }),
                    _cache[148] || (_cache[148] = _createElementVNode("div", { class: "aoa-section-title" }, "二级分类自定义填充", -1)),
                    _cache[149] || (_cache[149] = _createElementVNode("div", { class: "aoa-hint mb-2" }, "新增订阅时，按媒体的二级分类自动套用预设规则，每行一个分类，用 # 分隔字段，可用键：category、resolution、quality、effect、include、exclude、sites（站点名,逗号分隔）、savepath（支持 {name}）、filter_groups", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                    ...
                    _createVNode(_component_VDivider, { class: "my-4" }),
                    _cache[150] || (_cache[150] = _createElementVNode("div", { class: "aoa-section-title" }, "维护", -1)),
                    ...
                    _cache[151] || (_cache[151] = _createElementVNode("div", { class: "aoa-hint mt-2" }, "“清理已处理记录”后，已处理过的剧集下次下载会重新尝试填充", -1))
                  ]),
                  _: 1
                })
              ], 512), [
              ...
              _withDirectives(_createElementVNode("div", _hoisted_42, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[156] || (_cache[156] = _createElementVNode("div", { class: "aoa-section-title" }, "本地备份", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[152] || (_cache[152] = _createElementVNode("div", { class: "aoa-hint" }, "按计划打包配置目录到本地备份路径", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_VCol, {
                        ...
                        _createVNode(_component_VCol, {
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_43, [
                              _cache[153] || (_cache[153] = _createElementVNode("span", { class: "text-body-2" }, "本地保留份数", -1)),
                              _createVNode(_component_VChip, {
                                size: "small",
                                color: "primary",
                                variant: "tonal"
                            ...
                            _cache[154] || (_cache[154] = _createElementVNode("div", { class: "aoa-hint" }, "超出份数时自动删除最旧的备份，范围 1-30 份", -1))
                          ]),
                          _: 1
                        })
                      ]),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_45, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[158] || (_cache[158] = _createElementVNode("div", { class: "aoa-section-title" }, "WebDAV 远端备份", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, { cols: "12" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[157] || (_cache[157] = _createElementVNode("div", { class: "aoa-hint" }, "本地备份完成后同步上传到 WebDAV", -1))
                          ]),
                          _: 1
                        })
                      ]),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_46, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[161] || (_cache[161] = _createElementVNode("div", { class: "aoa-section-title" }, "插件日志清理", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[159] || (_cache[159] = _createElementVNode("div", { class: "aoa-hint" }, "按计划裁剪插件日志文件，仅保留指定行数", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_VCol, {
                    ...
                    _createVNode(_component_VDivider, { class: "my-4" }),
                    _cache[162] || (_cache[162] = _createElementVNode("div", { class: "aoa-section-title" }, "手动触发", -1)),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_48, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[165] || (_cache[165] = _createElementVNode("div", { class: "aoa-section-title" }, "MoviePilot 更新检查", -1)),
                    _cache[166] || (_cache[166] = _createElementVNode("div", { class: "aoa-hint mb-2" }, "仅检查并通知是否有新版本，不会在这里直接升级", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, { cols: "12" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[163] || (_cache[163] = _createElementVNode("div", { class: "aoa-hint" }, "默认仅提醒，开启后将在更新后尝试重启 MoviePilot", -1))
                          ]),
                          _: 1
                        })
                      ]),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_50, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[171] || (_cache[171] = _createElementVNode("div", { class: "aoa-section-title" }, "插件库更新检查", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[167] || (_cache[167] = _createElementVNode("div", { class: "aoa-hint" }, "按间隔检查已安装插件是否有新版本", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_VCol, {
                    ...
                    _createVNode(_component_VDivider, { class: "my-4" }),
                    _cache[172] || (_cache[172] = _createElementVNode("div", { class: "aoa-section-title" }, "自动更新已安装插件", -1)),
                    _cache[173] || (_cache[173] = _createElementVNode("div", { class: "aoa-hint mb-2" }, "检测到已安装插件有新版时自动下载安装并重载，不开启则仅在检查时提醒有新版", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[168] || (_cache[168] = _createElementVNode("div", { class: "aoa-hint" }, "高风险：会自动替换插件代码并重载，默认关闭，仅提醒，当前插件不会自动更新", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_VCol, {
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[169] || (_cache[169] = _createElementVNode("div", { class: "aoa-hint" }, "插件正在执行任务时不升级，避免中断", -1))
                          ]),
                          _: 1
                        })
                      ]),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_52, [
                _createVNode(_component_VForm, null, {
                  default: _withCtx(() => [
                    _cache[176] || (_cache[176] = _createElementVNode("div", { class: "aoa-section-title" }, "选择插件", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, { cols: "12" }, {
                          default: _withCtx(() => [
                    ...
                    _createVNode(_component_VDivider, { class: "my-4" }),
                    _cache[177] || (_cache[177] = _createElementVNode("div", { class: "aoa-section-title" }, "卸载与清理", -1)),
                    _createVNode(_component_VRow, null, {
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          cols: "12",
                    ...
                    _cache[179] || (_cache[179] = _createElementVNode("div", { class: "aoa-hint mt-2" }, "插件卸载为不可逆操作，执行前请确认目标插件和清理范围", -1))
                  ]),
                  _: 1
                })
              ], 512), [
              ...
              _withDirectives(_createElementVNode("div", _hoisted_54, [
                _createVNode(_component_VForm, { class: "aoa-seed-form" }, {
                  default: _withCtx(() => [
                    ...
                    _cache[184] || (_cache[184] = _createElementVNode("div", { class: "aoa-hint mb-3" }, "仅处理“同时满足所有已填条件”的种子，留空的条件不参与，全部留空则跳过不处理", -1)),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_58, [
                _createVNode(_component_VForm, { class: "aoa-media-form" }, {
                  default: _withCtx(() => [
                    _cache[186] || (_cache[186] = _createElementVNode("div", { class: "aoa-section-title" }, "媒体库服务器通知", -1)),
                    _cache[187] || (_cache[187] = _createElementVNode("div", { class: "aoa-hint aoa-line-hint mb-4" }, "需先在 MoviePilot 把媒体服务器 webhook 指向 MP", -1)),
                        ...
                        _createVNode(_component_VCol, { cols: "12" }, {
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_59, [
                              ...
                              _cache[185] || (_cache[185] = _createElementVNode("span", { class: "aoa-hint aoa-inline-hint" }, "监听 Emby/Jellyfin/Plex 的 webhook 事件，按筛选规则推送通知", -1))
                            ])
                          ]),
                          _: 1
                        })
              ...
              _withDirectives(_createElementVNode("div", _hoisted_60, [
                _createVNode(_component_VForm, { class: "aoa-dltag-form" }, {
                  default: _withCtx(() => [
                    _cache[190] || (_cache[190] = _createElementVNode("div", { class: "aoa-section-title" }, "按站点为种子批量补打标签", -1)),
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_VCol, {
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[188] || (_cache[188] = _createElementVNode("div", { class: "aoa-hint" }, "遍历下载器中的种子，按其 tracker 所属站点补打标签(已打的跳过，幂等安全)", -1))
                          ]),
                          _: 1
                        })
                      ]),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4a0586d8"]]);
