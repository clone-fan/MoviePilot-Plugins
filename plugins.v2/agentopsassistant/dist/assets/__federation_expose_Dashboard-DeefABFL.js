...
import { b as getPluginApiEnvelope, u as useAgentOpsTheme, c as usePanelActionRunner } from './useAgentOpsTheme-CbGFlsGV.js';
...
const _hoisted_2$a = { class: "v31-dashboard-toolbar__actions" };
...
return (_ctx, _cache) => {
  return (_openBlock$i(), _createElementBlock$d("header", _hoisted_1$b, [
    _cache[2] || (_cache[2] = _createElementVNode$a("div", null, [
      _createElementVNode$a("h1", { class: "v31-dashboard-toolbar__title" }, "MP 运维助手"),
      _createElementVNode$a("span", { class: "v31-dashboard-toolbar__subtitle" }, "仪表盘")
    ], -1)),
